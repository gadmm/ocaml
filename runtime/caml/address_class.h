...
_Bool caml_page_table_add(int kind, void *start, void *end);
_Bool caml_page_table_add_static_data(void *start, void *end);

#ifdef CAML_INTERNALS
void caml_static_area_add(void *start, void *end);
_Bool caml_page_table_initialize(mlsize_t bytesize);
#endif
