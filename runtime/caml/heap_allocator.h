...
/* Reserving, committing, decommitting large aligned blocks. Record
   the kind of allocation in the heap map. Platform-independent. */
...
/* reserve at least [request] contiguous memory, rounded up to the
   Pagetable_entry_size and record it with the heap table. Returns
   false on error. */
